...
import com.dinotech.elastic4s.akka.AkkaHttpClient.AllHostsBlacklistedException
import com.dinotech.elastic4s.http.{ElasticRequest, HttpEntity => ElasticEntity, HttpResponse => ElasticResponse}
