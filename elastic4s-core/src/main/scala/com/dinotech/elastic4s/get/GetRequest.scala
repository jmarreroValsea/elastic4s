package com.dinotech.elastic4s.get

import com.dinotech.elastic4s.{FetchSourceContext, IndexAndType, VersionType}
...
case class GetRequest(indexAndType: IndexAndType,
  ...
  def preference(pref: com.dinotech.elastic4s.Preference): GetRequest = preference(pref.value)
