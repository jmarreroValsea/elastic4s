...
import com.dinotech.elastic4s.FetchSourceContext
import com.dinotech.elastic4s.searches.{Highlight, HighlightField, HighlightOptions}
import com.dinotech.elastic4s.searches.sort.Sort
