...
import com.dinotech.elastic4s.script.ScriptField
import com.dinotech.elastic4s.searches.aggs.AbstractAggregation
import com.dinotech.elastic4s.searches.collapse.CollapseRequest
import com.dinotech.elastic4s.searches.queries._
import com.dinotech.elastic4s.searches.queries.matches.{MatchAllQuery, MatchQuery}
import com.dinotech.elastic4s.searches.queries.term.TermQuery
import com.dinotech.elastic4s.searches.sort.{FieldSort, Sort}
import com.dinotech.elastic4s.searches.suggestion.Suggestion
import com.dinotech.elastic4s.{FetchSourceContext, IndexesAndTypes}
...
case class SearchRequest(indexesTypes: IndexesAndTypes,
  ...
  def preference(pref: com.dinotech.elastic4s.Preference): SearchRequest = preference(pref.value)
