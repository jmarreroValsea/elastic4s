package com.dinotech.elastic4s.sttp

import java.io._
import java.nio.file.Files

import com.dinotech.elastic4s.ElasticsearchClientUri
import com.dinotech.elastic4s.http.HttpEntity.{ByteArrayEntity, FileEntity, InputStreamEntity, StringEntity}
import com.dinotech.elastic4s.http.{ElasticRequest, HttpClient, HttpEntity, HttpResponse}
