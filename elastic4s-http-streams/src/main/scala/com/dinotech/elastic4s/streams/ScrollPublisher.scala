...
import com.dinotech.elastic4s.http.search.{SearchHit, SearchResponse}
import com.dinotech.elastic4s.http.{ElasticClient, RequestFailure, RequestSuccess}
import com.dinotech.elastic4s.searches.SearchRequest
import com.dinotech.elastic4s.streams.PublishActor.Ready
