...
import com.dinotech.elastic4s.IndexAndTypes
import com.dinotech.elastic4s.bulk.BulkCompatibleRequest
import com.dinotech.elastic4s.http.ElasticDsl
import com.dinotech.elastic4s.http.bulk.BulkResponseItem
import com.dinotech.elastic4s.mappings.dynamictemplate.DynamicMapping.Strict
...
class ShipRequestBuilder(indexName: String = "bulkindexsubint") extends RequestBuilder[Ship] {
  ...
  import ElasticDsl._
  import com.dinotech.elastic4s.jackson.ElasticJackson.Implicits._
