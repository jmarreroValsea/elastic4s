...
import com.dinotech.elastic4s.script.ScriptType
import com.dinotech.elastic4s.searches.GeoPoint
import com.dinotech.elastic4s.searches.queries.geo.GeoDistanceQuery
import com.dinotech.elastic4s.searches.sort.{GeoDistanceSort, SortOrder, ScriptSortType}
