...
import com.dinotech.elastic4s.http.ElasticDsl.matchPhraseQuery
import com.dinotech.elastic4s.http.JsonSugar
import com.dinotech.elastic4s.searches.queries.funcscorer.{CombineFunction, FunctionScoreQuery, FunctionScoreQueryScoreMode, GaussianDecayScore}
