...
import com.dinotech.elastic4s.searches.DateHistogramInterval
import com.dinotech.elastic4s.searches.aggs._
import com.dinotech.elastic4s.searches.aggs.pipeline._
import com.dinotech.elastic4s.http.search.aggs.pipeline._
