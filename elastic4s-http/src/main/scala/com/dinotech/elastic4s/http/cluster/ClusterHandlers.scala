package com.dinotech.elastic4s.http.cluster

import com.fasterxml.jackson.annotation.JsonProperty
import com.dinotech.elastic4s.cluster.{ClusterHealthRequest, ClusterSettingsRequest, ClusterStateRequest}
import com.dinotech.elastic4s.http.{ElasticRequest, EnumConversions, Handler, HttpEntity}
