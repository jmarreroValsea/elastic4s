...
import com.dinotech.elastic4s.searches.queries.term.{BuildableTermsQuery, TermsQuery}
import com.dinotech.elastic4s.searches.{MultiSearchRequest, SearchRequest, SearchType}
