package com.dinotech.elastic4s.http.search.suggs

import com.dinotech.elastic4s.http.EnumConversions
import com.dinotech.elastic4s.json.{XContentBuilder, XContentFactory}
import com.dinotech.elastic4s.searches.suggestion.CompletionSuggestion
import com.dinotech.elastic4s.searches.suggestion.GeoContext
import com.dinotech.elastic4s.searches.suggestion.CategoryContext
