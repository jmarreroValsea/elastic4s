package com.dinotech.elastic4s.http.index.mappings

import com.dinotech.elastic4s.IndexesAndTypes
import com.dinotech.elastic4s.http._
import com.dinotech.elastic4s.indexes.PutMappingBuilderFn
import com.dinotech.elastic4s.mappings.{GetMappingRequest, PutMappingRequest}
