package com.dinotech.elastic4s.http.nodes

import com.fasterxml.jackson.annotation.JsonProperty
import com.dinotech.elastic4s.http.{ElasticRequest, Handler}
import com.dinotech.elastic4s.nodes.{NodeInfoRequest, NodeStatsRequest}
