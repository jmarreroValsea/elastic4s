...
import com.dinotech.elastic4s.delete.DeleteByIdRequest
import com.dinotech.elastic4s.http.index.VersionTypeHttpString
import com.dinotech.elastic4s.http.update.UpdateBuilderFn
import com.dinotech.elastic4s.indexes.{IndexContentBuilder, IndexRequest}
