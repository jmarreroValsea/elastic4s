package com.dinotech.elastic4s.http.index.admin

import java.net.URLEncoder

import com.dinotech.elastic4s.admin._
import com.dinotech.elastic4s.http._
import com.dinotech.elastic4s.http.index.admin.IndexShardStoreResponse.StoreStatusResponse
import com.dinotech.elastic4s.http.index.{CreateIndexContentBuilder, CreateIndexResponse}
import com.dinotech.elastic4s.indexes._
import com.dinotech.elastic4s.indexes.admin.{ForceMergeRequest, IndexRecoveryRequest}
