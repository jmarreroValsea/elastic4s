package com.dinotech.elastic4s.http.index.alias

import com.dinotech.elastic4s.Index
import com.dinotech.elastic4s.alias.{AddAliasActionRequest, GetAliasesRequest, IndicesAliasesRequest, RemoveAliasAction}
import com.dinotech.elastic4s.http._
import com.dinotech.elastic4s.http.index.admin.AliasActionResponse
