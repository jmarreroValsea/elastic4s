...
import com.dinotech.elastic4s.http.explain.Explanation
import com.dinotech.elastic4s.http.get.MetaDataFields
import com.dinotech.elastic4s.http.{Shards, SourceAsContentBuilder}
import com.dinotech.elastic4s.{Hit, HitReader}
