package com.dinotech.elastic4s.http.reindex

import com.fasterxml.jackson.annotation.JsonProperty
import com.dinotech.elastic4s.http._
import com.dinotech.elastic4s.http.task.CreateTaskResponse
import com.dinotech.elastic4s.reindex.ReindexRequest
