...
import com.dinotech.elastic4s.http.{EnumConversions, FetchSourceContextBuilderFn, ScriptBuilderFn}
import com.dinotech.elastic4s.http.search.aggs.AggregationBuilderFn
import com.dinotech.elastic4s.http.search.collapse.CollapseBuilderFn
import com.dinotech.elastic4s.http.search.queries.{QueryBuilderFn, SortBuilderFn}
import com.dinotech.elastic4s.http.search.suggs.{
...
import com.dinotech.elastic4s.searches.SearchRequest
import com.dinotech.elastic4s.searches.suggestion.{CompletionSuggestion, PhraseSuggestion, TermSuggestion}
